...
void GetSnowflakeConversionFunctions(TypeFactory* type_factory,
  ...
  InsertFunction(
      ...
      {{variant_type, {int64_type, {string_type, OPTIONAL}}, FN_TO_VARCHAR_INT64},
       {variant_type, {uint64_type, {string_type, OPTIONAL}}, FN_TO_VARCHAR_UINT64},
       {variant_type, {double_type, {string_type, OPTIONAL}}, FN_TO_VARCHAR_DOUBLE},
       {variant_type, {float_type, {string_type, OPTIONAL}}, FN_TO_VARCHAR_FLOAT},
       {variant_type, {numeric_type, {string_type, OPTIONAL}}, FN_TO_VARCHAR_NUMERIC},
       {variant_type, {bignumeric_type, {string_type, OPTIONAL}}, FN_TO_VARCHAR_BIGNUMERIC},
       {variant_type, {string_type, {string_type, OPTIONAL}}, FN_TO_VARCHAR_STRING},
       {variant_type, {bool_type, {string_type, OPTIONAL}}, FN_TO_VARCHAR_BOOL},
       {variant_type, {date_type, {string_type, OPTIONAL}}, FN_TO_VARCHAR_DATE},
       {variant_type, {datetime_type, {string_type, OPTIONAL}}, FN_TO_VARCHAR_DATETIME},
       {variant_type, {timestamp_type, {string_type, OPTIONAL}}, FN_TO_VARCHAR_TIMESTAMP},
       {variant_type, {time_type, {string_type, OPTIONAL}}, FN_TO_VARCHAR_TIME}},
