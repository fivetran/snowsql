...
#define ADD_TO_MAP(from_type, to_type, cast_type) \
  ...
  ADD_TO_MAP(STRUCT,     VARIANT,    IMPLICIT);
  ADD_TO_MAP(RANGE,      RANGE,      IMPLICIT);

  ADD_TO_MAP(VARIANT,    INT32,      IMPLICIT);
  ADD_TO_MAP(VARIANT,    INT64,      IMPLICIT);
  ADD_TO_MAP(VARIANT,    UINT32,     IMPLICIT);
  ADD_TO_MAP(VARIANT,    UINT64,     IMPLICIT);
  ADD_TO_MAP(VARIANT,    FLOAT,      IMPLICIT);
  ADD_TO_MAP(VARIANT,    DOUBLE,     IMPLICIT);
  ADD_TO_MAP(VARIANT,    STRING,     IMPLICIT);
  ADD_TO_MAP(VARIANT,    BYTES,      IMPLICIT);
  ADD_TO_MAP(VARIANT,    DATE,       IMPLICIT);
  ADD_TO_MAP(VARIANT,    TIMESTAMP,  IMPLICIT);
  ADD_TO_MAP(VARIANT,    TIME,       IMPLICIT);
  ADD_TO_MAP(VARIANT,    DATETIME,   IMPLICIT);
  ADD_TO_MAP(VARIANT,    INTERVAL,   IMPLICIT);
  ADD_TO_MAP(VARIANT,    ENUM,       IMPLICIT);
  ADD_TO_MAP(VARIANT,    PROTO,      IMPLICIT);
  ADD_TO_MAP(VARIANT,    BOOL,       IMPLICIT);
  ADD_TO_MAP(VARIANT,    NUMERIC,    IMPLICIT);
  ADD_TO_MAP(VARIANT,    BIGNUMERIC, IMPLICIT);
  ADD_TO_MAP(VARIANT,    RANGE,      IMPLICIT);
  ADD_TO_MAP(VARIANT,    OBJECT,     IMPLICIT);
  ADD_TO_MAP(VARIANT,    VARIANT,    IMPLICIT);
